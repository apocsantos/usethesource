...
void processCommand(String command)
{
  ...
  //dht11-1
    if (command.indexOf("dht1") > -1)
    {
      ...
      server.println("Reading from DHT11 Sensor 1: " );
  ...
  //dht11-2
    ...
    {
      Serial.println("dht1 command received"); 
      server.println("Reading from DHT11 Sensor 2: " );
  ...
  //light
    if (command.indexOf("light") > -1)
    {
      ...
      server.println("Reading from light sensor: " );
      delay(200);
...
//this crap is to be removed, cause this is not intended for human usage!!!
void instructions()
{
   server.println("I don't understand");
   server.println("Please use one of these commands:");
   server.println("* dht1, get humidity and temperature from dht11-1");
   server.println("* dht2, get humidity and temperature from dht11-2");
   server.println("* light, get light");
   server.println("* satsolo, get soil stauration from moisture sensor");
   server.println("* onpump,  starts pump with relay");
   server.println("* offpump, stops pump with relay");
}
