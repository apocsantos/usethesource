...
while True: # While loop that loops forever
    ...
    fhs = float(fmois)                      #didnt you got it yet? *f you must me an ass!
    ...
    luxArray = array('f')                   #declares an array of floats (yes! you need to store the data somewhere right ? dont play a *f iDiot with me! Ok ?)
